      ...
      sessions: [
        {
          ...
          votes: ['bradgreen', 'igorminar', 'martinfowler']
        },
        {
          id: 2,
          ...
          votes: ['johnpapa', 'bradgreen', 'igorminar', 'martinfowler']
        },
        {
          id: 3,
    ...
    },
    {
      ...
      sessions: [
        ...
        },
        {
          ...
          votes: ['bradgreen', 'igorminar', 'johnpapa']
        },
        {
          id: 3,
      ...
      sessions: [
        {
          ...
          votes: ['bradgreen', 'martinfowler', 'igorminar']
        },
        {
          id: 2,
        ...
        },
        {
          ...
          votes: ['bradgreen', 'martinfowler', 'johnpapa']
        },
        {
          id: 4,
          name: "ng-wat again!!",
          ...
          votes: ['bradgreen', 'martinfowler', 'igorminar', 'johnpapa']
        },
        {
          id: 5,
